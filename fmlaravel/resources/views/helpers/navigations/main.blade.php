<div class="nav-main-wrapper">
    <div class="nav-main-title visible-xs">
        <a href="#">
            {{ HTML::image('assets/img/logo-blue.png', 'TimTro') }}
        ...
        <nav>
            <ul id="nav-main" class="nav nav-pills">
                <li class="has-children ">
                    <a href="headers-google-map.html#">Properties <i class="fa fa-caret-down"></i></a>
                ...
                <li class="has-children ">
                    <a href="headers-google-map.html#">Agents <i class="fa fa-caret-down"></i></a>
                ...
                <li class="has-children  active ">
                    <a href="headers-google-map.html#">Variants <i class="fa fa-caret-down"></i></a>
                    ...
                    <div>
                        ...
                        <ul class="sub-menu">
                            <li class="has-children">
                                <a href="headers-google-map.html#">Headers</a>
                            ...
                            <li class="has-children">
                                <a href="headers-google-map.html#">Footers</a>
                ...
                <li class="has-children ">
                    <a href="headers-google-map.html#">Pages <i class="fa fa-caret-down"></i></a>
                ...
                <li class="has-children ">
                    <a href="headers-google-map.html#">Blog <i class="fa fa-caret-down"></i></a>
